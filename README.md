...
[![Production Dashboard](https://img.shields.io/badge/Live%20Demo-nexus.53.workers.dev-06b6d4?style=flat-square&logo=cloudflare)](https://service.example.com)
...
| :--- | :--- | :--- | :---: |
| 🌐 **Nexus Command Dashboard** | [`https://service.example.com`](https://service.example.com) | Global Edge Worker UI + ECharts 5 + Supabase Auth | 🟢 **ONLINE** |
| 🚇 **Nexus Private API Gateway** | `https://tunnel.example.com` | Zero-Trust Cloudflare Tunnel ➡️ FastAPI Bridge | 🟢 **ACTIVE** |
| 🗄️ **Time-Series Telemetry Store** | Private Subnet (`mysql.example.internal:3306`) | Oracle Cloud MySQL HeatWave DB System | 🟢 **ACTIVE** |
