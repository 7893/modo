...
| :--- | :--- | :--- | :---: |
| 🌐 **MODO Command Dashboard** | [`https://service.example.com`](https://service.example.com) | Edge Worker UI + ECharts 5 Multi-Curtain Panorama | 🟢 **ONLINE** |
| 🚇 **MODO Private API Gateway** | `https://tunnel.example.com` | Zero-Trust Cloudflare Tunnel ➡️ FastAPI Node Gateway | 🟢 **ACTIVE** |
